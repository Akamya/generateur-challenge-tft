...
<template>
    <AppLayout :show-background="true">
        ...
        <!-- Main Content -->
        <main class="relative flex-grow w-full py-12 px-4 justify-center">
            <!-- Logo and Title -->
            ...
            <!-- Content Container -->
            <div class="bg-blue-900/80 rounded-lg p-8 max-w-7xl w-full mx-auto">
                <!-- Origins Content -->
                ...
                <!-- Positions Content -->
                <div v-if="activeCategory === 'positions'" class="space-y-6">
                    <h2
                        class="text-white text-2xl font-bold mb-6 text-center border-b border-yellow-500 pb-2"
                    >
                        POSITIONS
                ...
                <!-- Constraints Content -->
                <div v-if="activeCategory === 'constraints'" class="space-y-6">
                    <h2
                        class="text-white text-2xl font-bold mb-6 text-center border-b border-yellow-500 pb-2"
                    >
                        CONSTRAINTS
