        ...
        <div class="min-h-full flex flex-col relative overflow-hidden">
            ...
            >
                ...
                <div class="flex flex-col items-center mb-8">
                    ...
                    <h1
                        class="text-4xl font-bold mb-2 text-red-500 font-parkinsans text-center"
                    >
                        CHALLENGE FAILED
                    </h1>
                    <div class="w-80 h-1 bg-primary-first mb-6"></div>
                    ...
                    <div class="p-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div
                                ...
                                class="bg-primary-dark/80 rounded-xl p-4 hover:bg-primary-dark transition-colors shadow-md border"
                                :class="
